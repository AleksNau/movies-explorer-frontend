        ...
        <li className="movies-card">
            ...
            {pathname === "/movies" ? !isChecked ? (
                ...
                <svg width="7" height="7" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3.5 4.44287L5.85705 6.79992L6.91771 5.73926L4.56066 3.38221L6.79992 1.14295L5.73926 0.0822905L3.5 2.32155L1.26086 0.0824062L0.200195 1.14307L2.43934 3.38221L0.0824064 5.73914L1.14307 6.7998L3.5 4.44287Z" fill="white"/>
                </svg>
            </button>)}
